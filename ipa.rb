  ...
  module Actions
    ...
    class IpaAction < Action
      ...
      def self.description
        "Easily build and sign your app using shenzhen111"
      end
      ...
      def self.example_code
        [
          'gym(
            workspace: "TeamCityiOSTest.xcodeproj/TeamCityiOSTest.xcworkspace",
            configuration: "Debug",
            scheme: "TeamCityiOSTest",
            # (optionals)
            clean: true,                     # This means "Do Clean". Cleans project before building (the default if not specified).
            destination: "~/",      # Destination directory. Defaults to current directory.
            ipa: "TeamCityiOSTest-app.ipa",               # specify the name of the .ipa file to generate (including file extension)
